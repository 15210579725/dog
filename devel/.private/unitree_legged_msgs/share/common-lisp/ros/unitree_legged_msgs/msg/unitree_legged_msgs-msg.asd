...
(defsystem "unitree_legged_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "downstream" :depends-on ("_package_downstream"))
    (:file "_package_downstream" :depends-on ("_package"))
    (:file "upstream" :depends-on ("_package_upstream"))
    (:file "_package_upstream" :depends-on ("_package"))
  ))